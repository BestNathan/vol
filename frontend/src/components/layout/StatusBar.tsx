  ...
  return (
    <div className={statusCls}>
      <div className="flex items-center gap-1.5 overflow-hidden flex-nowrap sm:gap-1">
        ...
        {isRunning && (
          <span className="px-1.5 py-0.5 rounded-[3px] text-[11px] font-bold bg-yellow-950/30 text-yellow-400">
            {statusLabel}
          </span>
        )}
        {!isRunning && (
          <span className="px-1.5 py-0.5 rounded-[3px] text-[11px] font-bold bg-emerald-950/30 text-emerald-400">
            {statusLabel}
          </span>
        )}
        {unsafeMode && (
          <span className="px-1.5 py-0.5 rounded-[3px] text-[11px] font-bold bg-red-950/30 text-destructive">
            !! UNSAFE
          </span>
        )}
        {exiting && (
