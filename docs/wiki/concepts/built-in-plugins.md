...
**Related:** [[agent-plugin-system]], [[plugin-actions]], [[rate-limiting]], [[agent-observability]], [[semantic-caching]], [[human-in-the-loop]], [[retry-with-backoff]]

## Definition

The 5 plugins shipped with the ReAct Agent system, each handling a specific cross-cutting concern.
