...
| [[vol-llm-sandbox-crate]] | Sandbox lifecycle management: SandboxManager (sole resolution path — instance lookup by SandboxId plus profile lookup via acquire_by_name/preload/build_inline), SandboxProvider (backend adapters), SandboxStore (metadata), SandboxCapabilities; spec.rs is the single TOML schema source; implementations: Local/Tmp/SSH/Firecracker/Wasm; SandboxRegistry deleted 2026-08-28 | active | 2026-08-28 |
