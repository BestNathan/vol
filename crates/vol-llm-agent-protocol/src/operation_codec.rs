...
pub fn method_to_operation(method: &str) -> Result<Operation, ProtocolError> {
    match method {
        ...
        "control.task_list" => Ok(Operation::Control(ControlOperation::TaskList)),
        "control.task_list_result" => Ok(Operation::Control(ControlOperation::TaskListResult)),
        "control.task_get" => Ok(Operation::Control(ControlOperation::TaskGet)),
        "control.task_get_result" => Ok(Operation::Control(ControlOperation::TaskGetResult)),
        "sandbox.list" => Ok(Operation::Sandbox(SandboxOperation::List)),
        "sandbox.list_specs" => Ok(Operation::Sandbox(SandboxOperation::ListSpecs)),
